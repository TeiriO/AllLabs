...
namespace Task8_8_Lib
{
    public class Coordinates
    {
        ...
        public Coordinates(int x, int y, int step) : this(x, y)
        {
            Step = step;
        }
        ...
        public bool HorizonNear(Coordinates coordinates, int distance)
        {
            return Math.Abs(X - coordinates.X) <= distance;
        }
        ...
        {
            return new Coordinates(X, Y, Step);
        }
    }
}
